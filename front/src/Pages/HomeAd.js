...
const Home = () => {
  ...
  const handleAddProduit = async () => {
    ...
    try {
      ...
      console.log("Produit added successfully:", response.data);
      closeAddMedModal();
      fetchallProduits();
    } catch (error) {
  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <input placeholder="Prix" type="number" value={updateProduitData.prix} onChange={(e) => setUpdateProduitData({ ...updateProduitData, prix: e.target.value })} />
        </div>
        <div>
          <input placeholder="Quantité en stock" type="number" value={updateProduitData.quantiteStock} onChange={(e) => setUpdateProduitData({ ...updateProduitData, quantiteStock: e.target.value })} />
        </div>
        <div>
        ...
        <div>
          <button style={{ width: '120px',  marginRight: '10px' }}onClick={handleUpdateProduit}>Enregistrer </button>
      ...
      >
        ...
        <div>
          <button style={{ width: '120px',  marginRight: '10px' }}onClick={handleAddProduit}>Ajouter</button>
